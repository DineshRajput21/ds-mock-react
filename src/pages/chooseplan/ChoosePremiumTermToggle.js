...
function ChoosePremiumTermToggle({ title, content, ...props }) {
    ...
    return (
        <div className={rootClasses.root}>
            <Collapse in={expanded === 'panel1'}>
                <p className={rootClasses.content}>Limited years premium term means that you’ll pay up to the policy anniversary after your 67th birthday or for 20 years from entry age, whichever is later.</p>
                <p className={rootClasses.content}>Premium term until you’re 98 years old means that you’ll pay up to the policy anniversary after your 97th birthday.</p>
            </Collapse>
            <Accordion classes={{
...
export default ChoosePremiumTermToggle;